...
const SideNavbar: FC<ISideNavbar> = ({ isOpen, onClose, closeNav }) => {
  ...
  useEffect(() => {
    const handleOutsideClick = (e: any) => {
      isOpen && ref.current !== null && !ref.current.contains(e.target) && closeNav();
    };
    ...
    <div className={'sidebar' + (isOpen ? ' open' : '')} ref={ref}>
      <div className="container">
        <nav>
          ...
          <ul>
            <li>
              <a target="_blank" rel="noreferrer" href="https://github.com/BedrockLauncher/BedrockLauncher/" onClick={onClose}>
                Launcher Source
              </a>
            </li>
            <li>
              <a target="_blank" rel="noreferrer" href="https://github.com/BedrockLauncher/BedrockLauncher.github.io" onClick={onClose}>
                Website Source
              </a>
            </li>
            <li>
              <a target="_blank" rel="noreferrer" href="https://crowdin.com/projects/bedrocklauncher" onClick={onClose}>
                Localization
              </a>
            </li>
            <li>
          ...
          <ul>
            <li>
              <a rel="noreferrer" href="/downloads">
                Download Launcher
              </a>
            </li>
            <li>
