...
export const FAQCategories = [
  {
    ...
    img: '/images/banners/other_early_console_era.jpg'
  },
  {
    name: 'data',
    title: 'Data FAQ',
    description: 'Issues with your Minecraft worlds, settings, etc?',
    img: '/images/banners/1.13_technically_updated_java.jpg'
  },
  {
    name: 'accounts',
    title: 'Accounts FAQ',
    description: 'Questions about managing Minecraft accounts?',
    img: '/images/banners/1.09_combat_update_java.jpg'
  },
  {
    name: 'misc',
    title: 'Miscellaneous FAQ',
    description: 'Issues with your Minecraft worlds, settings, etc?',
    img: '/images/banners/1.08_cats_and_pandas.jpg'
  }
];
...
const FAQs: IFAQItem[] = [
  ...
  },
  {
    ...
    body: `<p>They can be found in the quick launch prompt:</p><img src="/images/version_chooser.png">`
  },
  {
    id: 'faq-560145e1',
    tag: 'misc',
  ...
  },
  {
    ...
    body: `<h3>Creating an account on first launch</h3><p>When launching the launcher for the first time, you'll be greeted with this screen:</p><img src="/images/first_launch_welcome.png"><p>Click next.</p><img src="/images/first_launch_one_thing.png"><p>Click next once more and then choose an account you desire to use to launcher Minecraft (this account should own Minecraft For Windows 10). Then click next.</p><img src="/images/first_launch_insider_account.png"><img src="/images/first_launch_almost_there.png"><p>And just like that, you have created an account in your first launch!</p><img src="/images/coolabhi1290_profile_in_launcher.png"><br><br><br><h5 class="subtle">Creating an account after first launch</h5><p>Click on the profiles button.</p><img src="/images/coolabhi1290_profile_in_launcher_click.png"><p>Then click add profile.</p><img src="/images/add_profile_button.png"><p>You'll be then greeted by this screen:</p><img src="/images/add_profile_prompt.png"><p>Type in your desired name and click "CREATE"; In this example, I created a profile called <code>Abhi's New Profile</code>. Now click on the profiles button again, and voila, your new profile is ready!</p><img src="/images/new_profile_added.png">`
  },
  {
    id: 'faq-8aa21b40',
    tag: 'accounts',
  ...
  },
  {
    ...
    body: `<p>To play a beta or a Preview, you can either create a custom installation for a specific beta version or play the Latest Beta version provided by default in the launcher.</p><img src="/images/latest_beta.png">`
  },
  {
    id: 'faq-bdef087b',
    tag: 'accounts',
  ...
  },
  {
    ...
    body: `<p>Read the "Why do my worlds not show up sometimes?" FAQ to understand how certain insallations access certain folders.</p><p>Pick an installation folder that you desire all versions to access. For example, I created a folder called <code>Abhi's Worlds</code> and transfered all my worlds to it.</p><img src="/images/custom_installation_folder.png"><p>Now, go to the installations tab</p><img src="/images/installations_tab.png"><p>Click the three dots (to open installation configurations)</p><img src="/images/installations_settings.png"><p>In the <code>DIRECTORY</code> input, type in your folder's name. In my case, it is <code>Abhi's Folders</code>.</p><img src="/images/installation_directory.png"><p>Finally, click save!</p><img src="/images/installation_save.png"><p>Repeat this proccess for each version that you want to be able to access those worlds. In my case, I did it for all versions to mimic Minecraft Java's behaviour.</p>`
  },
  {
    id: 'faq-dfc054d7',
    tag: 'data',
