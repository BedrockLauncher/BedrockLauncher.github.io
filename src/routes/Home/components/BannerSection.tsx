  ...
  return (
    <div className="main-section" style={{ backgroundImage: 'url(' + covers[coverIndex] + ')' }}>
      ...
      <div className="buttons-group0">
        <ButtonText type="link" to="https://github.com/bedrockLauncher/BedrockLauncher/releases/latest/download/release.zip" rel="noreferrer" target="_blank" width={160}>
          Download
        </ButtonText>
      ...
      <div className="buttons-group1">
        ...
        <ButtonText type="link" content="icon" target="_blank" to="https://discord.gg/Ar5SRBZcqn" width={40}>
