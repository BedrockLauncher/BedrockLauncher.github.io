    ...
    <>
      ...
      <main className='home-show-sections'>
        <div className='container'>
          {ShowSections.map(s => { return { ...s, img: s.img.replaceAll('%PUBLIC_PATH%', process.env.PUBLIC_URL) } }).map((sec, i) => {
            return <ShowSectionItem key={sec.id} info={sec} invertOrder={i % 2 !== 0} /> 
          })}
